                 ...
                 <div class="grid grid-cols-2 gap-4 text-sm">
                     <div class="group relative">
                         ...
                         <div class="flex items-center gap-2">
                            <p class="font-bold text-text-body">Banco Plaza (0138)</p>
                            <button @click="copyToClipboard('0138')" class="text-primary-600 hover:text-primary-700 opacity-0 group-hover:opacity-100 transition-opacity" title="Copiar Banco">
