<template>
  <div v-if="showWarning" class="bg-red-600 text-white px-4 py-2 text-sm font-bold text-center flex items-center justify-center gap-4 shadow-md relative z-50">
      ...
      <NuxtLink to="/app/settings?tab=subscription" class="bg-white text-red-600 px-3 py-1 rounded hover:bg-gray-100 transition-colors text-xs uppercase tracking-wider">
          Actualizar Pago
      </NuxtLink>
  </div>
</template>
